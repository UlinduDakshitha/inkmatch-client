...
interface StudioBookingsProps {
  studioId: string | number;
}

export default function StudioBookings({ studioId }: StudioBookingsProps) {
    ...
    <div style={{ maxWidth: "900px" }}>
      ...
      {bookings.length === 0 ? (
        ...
        >
          ...
          >
            No bookings yet. When customers book studio sessions, they'll appear
            here.
          </p>
        </div>
      ) : (
